...
abstract class DurationFormat {
  ...
  Duration parse(String string) => Duration();
}
...
/// default).
class TimerField extends FormField<Duration> {
  TimerField({
    ...
    ValueChanged<Duration?>? onFieldSubmitted,
    ...
    InputCounterWidgetBuilder? buildCounter,
            ...
            onSaved: onSaved,
            builder: (field) {
              final _TimerFieldState state = field as _TimerFieldState;
              ...
              return TextField(
                ...
                maxLength: maxLength,
                onChanged: (string) =>
                    field.didChange(tryParse(string, formatter)),
                onEditingComplete: onEditingComplete,
                onSubmitted: (string) => onFieldSubmitted == null
                    ? null
                    : onFieldSubmitted(tryParse(string, formatter)),
  ...
  final DurationFormat formatter;
  ...
  @override
  _TimerFieldState createState() => _TimerFieldState();

  /// Returns an empty string if [DateFormat.format()] throws or [date] is null.
  static String tryFormat(Duration? duration, DurationFormat formatter) {
    if (duration != null) {
      try {
  ...
  static Duration? tryParse(String string, DurationFormat formatter) {
...
class _TimerFieldState extends FormFieldState<Duration> {
  ...
  @override
  TimerField get widget => super.widget as TimerField;
  ...
  @override
  void didUpdateWidget(TimerField oldWidget) {
  ...
  String format(Duration? duration) =>
      TimerField.tryFormat(duration, widget.formatter);
  Duration? parse(String text) => TimerField.tryParse(text, widget.formatter);
